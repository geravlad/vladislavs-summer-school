...
describe("End-to-end user flow", () => {
  ...
  it("fills out shipping form", () => {
    ...
    Checkout.elements.firstNameField().type("Tester");
    Checkout.elements.lastNameField().type("Teamone");
    Checkout.elements.addressField().type("Tester");
    Checkout.elements.postalCodeField().type("1234");
    Checkout.elements.cityField().type("TestCity");
